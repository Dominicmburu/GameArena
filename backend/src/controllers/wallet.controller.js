...
/**
 * FIXED: Atomic payment processing with proper field handling
 */
...
//           console.log(`Callback received but payment already processed: ${checkoutRequestId}`);
          
//           // Update with M-Pesa receipt if missing
//           if (result.existingTransaction) {
//             const existingMeta = result.existingTransaction.meta || {};
            
//             if (!existingMeta.MpesaReceiptNumber && metadata.MpesaReceiptNumber) {
//               console.log(`Updating transaction with M-Pesa receipt: ${metadata.MpesaReceiptNumber}`);
...
//               console.log(`✅ Updated transaction with callback receipt details`);
//             }
//           }
//         } else {
...
// M-Pesa B2C Result Callback - FIXED
